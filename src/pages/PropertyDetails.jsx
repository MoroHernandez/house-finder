	...
	return (
		<section>
			<div className='container mx-auto min-h-[800px] mb-14'>
				...
				<article className='flex flex-col items-start gap-8 lg:flex-row'>
					<div className='max-w-[768px]'>
						<div className='mb-8 '>
							<img src={house.imageLg} alt='detail image' />
						</div>
					...
					>
						...
						<form className='flex flex-col gap-y-4'>
							...
							<div className='flex gap-x-2'>
								<button
									className='bg-violet-700 hover:bg-violet-800 text-white rounded
								p-4 text-sm w-full transition'
								>
									Send message
								</button>
								<button
